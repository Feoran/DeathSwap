...
tp @a -1 72 -26
setworldspawn -1 72 -26
setblock -17 66 -37 minecraft:structure_block{mirror:"NONE",powered:0b,name:"deathswap:mianlobby",rotation:"NONE",mode:"LOAD",id: "minecraft:structure_block",metadata:"",ignoreEntities:1b}
setblock -17 67 -37 minecraft:redstone_block
...
setblock -17 66 -37 air
setblock -3 218 -3 air
setblock -17 67 -37 air
setblock -17 66 -37 air
